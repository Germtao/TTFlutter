...
class NestedScrollViewRefreshIndicatorState extends State<NestedScrollViewRefreshIndicator>
  ...
  bool _handleScrollNotification(ScrollNotification notification) {
    ...
    maxContainerExtent = math.max(notification.metrics.viewportDimension, this.maxContainerExtent);
...
bool nestedScrollViewScrollNotificationPredicate(ScrollNotification notification) {
  return true;
}
