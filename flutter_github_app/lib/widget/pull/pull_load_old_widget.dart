...
/// 通用上下拉刷新控件
class PullLoadOldWidget extends StatefulWidget {
  /// item 渲染
  ...
  @override
  _PullLoadOldWidgetState createState() => _PullLoadOldWidgetState();
}

class _PullLoadOldWidgetState extends State<PullLoadOldWidget> {
    ...
    return new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          FlatButton(
            onPressed: () {},
            child: new Image(image: new AssetImage(TTIcons.DEFAULT_USER_ICON), width: 70.0, height: 70.0),
          ),
          Container(
            child: Text(TTLocalizations.i18n(context).appEmpty, style: TTConstant.normalText),
          ),
        ],
      ),
    );
...
class PullLoadOldWidgetControl {
  /// 数据，对齐增减，不能替换
  List dataList = List();
