...
class BubbleDemoPage extends StatelessWidget {
  ...
  getY4() {
    if (isClient()) {
      return getY(button4Key) - bubbleHeight - MediaQueryData.fromWindow(WidgetsBinding.instance.window).padding.top;
    } else {
        ...
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              ...
              top: MediaQuery.of(context).size.height / 2 - MediaQuery.of(context).padding.top - kToolbarHeight,
            ),
          ],
        ),
      ),
