...
class RealRichText extends Text {
  ...
  Widget build(BuildContext context) {
    ...
    if (MediaQuery.boldTextOverride(context))
      effectiveTextStyle = effectiveTextStyle.merge(TextStyle(fontWeight: FontWeight.bold));
    ...
    GestureRecognizer recognizer,
        ...
        super(
            style: TextStyle(
                ...
                height: 1,
                fontSize: (imageHeight / 1.15) + (margin == null ? 0 : margin.vertical)),
            text: "\u200B",
            children: [],
    ...
    for (TextSpan textSpan in (text as TextSpan).children) {
      if (textSpan is ImageSpan) {
        ...
        Offset topLeftOffset = Offset(
            offset.dx + offsetForCaret.dx - (textOffset == 0 ? 0 : textSpan.width / 2), offset.dy + offsetForCaret.dy);
        debugPrint(
